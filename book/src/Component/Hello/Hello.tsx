...
function Hello(){
    ...
    useEffect(() => {
        tl.fromTo(".letter", {opacity: 0, x: 200 }, {opacity: 1, x: 0, stagger: 0.15})
        tl.to(".letter", {fontSize: '8vw',delay: 0.3, letterSpacing: '4vw', x: 0,})
        tl.to(".letter",{x: -200,delay: 0.4, duration: 0.4, stagger: 0.1, opacity: 0})
